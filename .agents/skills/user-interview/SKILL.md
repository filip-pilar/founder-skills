---
name: user-interview
description: Prepare customer interviews or synthesize supplied interview evidence.
---
...
Deliver a usable interview guide or a concise synthesis with evidence, implications and the next decision. If material is missing, complete what the evidence supports and ask only for the missing input that changes the conclusion. Do not invent interviews, quotes or willingness to pay.

Read [references.md](references.md) for question design or conflicting feedback; [example.md](example.md) shows a limited-evidence conclusion. Outreach writing can be handled separately when that is the actual deliverable.
